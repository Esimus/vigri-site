// app/dashboard/faq/solflare/page.tsx
'use client';
          ...
          {step.figure && (
            <details className="card p-3">
              ...
              <div className="mt-3 space-y-2">
                ...
                <p className="text-xs text-zinc-600">{zoomHint}</p>
              </div>
            </details>
          )}
        </div>
...
export default function SolflareFaqPage() {
  const { t } = useI18n();
  ...
  return (
    <FaqLightboxProvider>
      <div className="space-y-8">
        <div className="card p-4">
          <h1 className="text-2xl font-semibold">{t('faq_solflare_page_title')}</h1>
          <p className="mt-2 text-sm text-zinc-600">{t('faq_solflare_page_intro')}</p>
        </div>
        ...
        {sections.map((section) => (
          <section key={section.titleKey} className="space-y-4">
            <div className="space-y-1">
              ...
              {section.descKey && <p className="text-sm text-zinc-600">{t(section.descKey)}</p>}
            </div>
