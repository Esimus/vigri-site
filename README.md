...
- **Next.js App Router** (Next.js 16.3.5)
...
- **Frontend / Server:** Next.js (App Router) 16.3.5, React 19.3.0, TypeScript 6.0.3
- **Styling:** Tailwind CSS v4.3.3
- **Database:** PostgreSQL + Prisma 7.10.0
- **Solana:** `@solana/kit` 7.1.1, `@solana/wallet-account-signer` 7.1.1
- **Wallets:** `@wallet-ui/react` 4.3.0, Wallet Standard app integration
...
- Node.js **26.10.0** (project version via `.nvmrc`; `package.json` requires `>=26.10.0`)
